...
const AGENT_IMAGE_LIBRARY = [
  ...
  { name: "Automation", url: "/agent-avatars/automation.svg", keywords: ["automation", "agentic", "pipeline", "tasks", "orchestration"] },
  { name: "Finance", url: "/agent-avatars/finance.svg", keywords: ["finance", "trading", "market", "money", "invest"] },
  { name: "Commerce", url: "/agent-avatars/commerce.svg", keywords: ["commerce", "sales", "shop", "ecommerce", "conversion"] },
  ...
  { name: "Translation", url: "/agent-avatars/translation.svg", keywords: ["translation", "language", "localization", "multilingual", "i18n"] },
